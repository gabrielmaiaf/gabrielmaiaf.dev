...
enum FileFieldsEnum {
  ...
  childMarkdownRemark___frontmatter___alt = 'childMarkdownRemark.frontmatter.alt',
  ...
  childMarkdownRemark___fields___langKey = 'childMarkdownRemark.fields.langKey',
...
enum MarkdownRemarkFieldsEnum {
  ...
  frontmatter___featuredImage___fields___slug = 'frontmatter.featuredImage.fields.slug',
...
enum SiteFieldsEnum {
  ...
  siteMetadata___languages___langs = 'siteMetadata.languages.langs',
  siteMetadata___languages___defaultLangKey = 'siteMetadata.languages.defaultLangKey',
  port = 'port',
  host = 'host',
  polyfill = 'polyfill',
...
enum SitePageFieldsEnum {
  ...
  pluginCreator___pluginOptions___emitSchema___src__types_gatsby_introspection_json = 'pluginCreator.pluginOptions.emitSchema.src__types_gatsby_introspection_json',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___emitSchema___src__types_gatsby_introspection_json = 'pluginOptions.emitSchema.src__types_gatsby_introspection_json',
...
type SitePluginPluginOptionsEmitSchema = {
  readonly src__types_gatsby_introspection_json: Maybe<Scalars['Boolean']>;
};

type SitePluginPluginOptionsEmitSchemaFilterInput = {
  readonly src__types_gatsby_introspection_json: Maybe<BooleanQueryOperatorInput>;
};
...
type SitePluginPluginOptionsMarkdownRemark = {
  readonly postPage: Maybe<Scalars['String']>;
  readonly query: Maybe<Scalars['String']>;
};

type SitePluginPluginOptionsMarkdownRemarkFilterInput = {
  readonly postPage: Maybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly languages: Maybe<SiteSiteMetadataLanguagesFilterInput>;
};
...
type SiteSiteMetadataLanguagesFilterInput = {
  readonly langs: Maybe<StringQueryOperatorInput>;
  readonly defaultLangKey: Maybe<StringQueryOperatorInput>;
};
...
type BlogPostByPathQuery = { readonly markdownRemark: Maybe<(
    ...
    & { readonly frontmatter: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'alt' | 'link' | 'description'>
...
type BlogEnQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
...
type BlogPtQueryQueryVariables = Exact<{ [key: string]: never; }>;


type BlogPtQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'id' | 'excerpt'>
        & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date'>>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'langKey'>> }
      ) }> } };
...
type LayoutQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly languages: Maybe<Pick<SiteSiteMetadataLanguages, 'defaultLangKey' | 'langs'>> }> }> };
...
type ImageQueryQuery = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }> };
